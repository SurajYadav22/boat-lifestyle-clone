      ...
      {chat ? (
        <Chat className="chat">
          ...
          <div className="chat-background">
            ...
            />
            <div className="live-chat">
              Note: You can type 'menu' or 'hi' to come back to the main menu
            </div>
            <div className="chatOptions">
              <button classname="chat-buttons">Track My Current Order</button>
              <button classname="chat-buttons">
                Find Nearest Service Center
              </button>
              <button classname="chat-buttons">Download Invoice</button>
              <button classname="chat-buttons">Returns and Refunds</button>
              <button classname="chat-buttons">
